...
# iamport setting
IAMPORT_KEY = '0357921269465112'
IAMPORT_SECRET = 'xTlxYd22yALsQTGsS84rhbD1P3wG0X1xQm5PA8S8JDAzxh1pp6RHivJ7yfOydQ64dcTNkLV4pwDWNFmd'
...
# SELECT CONCAT("ALTER TABLE ", TABLE_NAME," CONVERT TO CHARACTER SET utf8") AS ExecuteTheString FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA="ebdb" AND TABLE_TYPE="BASE TABLE"
