...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('created', 'Created'), ('paid', 'Paid'), ('refunded', 'Refunded'), ('processing', 'Processing'), ('request_refund', 'request_refund'), ('wait_confirm', 'wait_confirm'), ('finished', 'Finished')], default='created', max_length=120)),
